...
import 'package:ecommerce/pages/subpages/existingproductdetailvariableimage.dart';
...
class ExistingProductDetailVariablePage extends StatefulWidget {

  final String userProductId;
  final ProductVariable productVariable;
  late void Function() updateShowImages;

  ExistingProductDetailVariablePage({super.key, required this.userProductId, required this.productVariable, required this.updateShowImages});

  @override
  State<ExistingProductDetailVariablePage> createState() => ExistingProductDetailVariableState();
}

class ExistingProductDetailVariableState extends State<ExistingProductDetailVariablePage> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: imageUrls.map((imageUrls) =>
                      ExistingProductDetailVariableImage(userProductId: widget.userProductId, index: widget.productVariable.index, imageUrls: imageUrls),
                    ).toList(),        
                  ),
                ),
              ),
