...
class ExistingProductDetailVariableImage extends StatefulWidget {

  final List<String> imageUrls;
  final String userProductId;
  final int index;

  const ExistingProductDetailVariableImage({super.key, required this.userProductId, required this.index, required this.imageUrls});

  @override
  State<ExistingProductDetailVariableImage> createState() => ExistingProductDetailVariableImageState();
}

class ExistingProductDetailVariableImageState extends State<ExistingProductDetailVariableImage> {
